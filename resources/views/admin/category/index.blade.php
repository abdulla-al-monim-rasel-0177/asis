@extends('layouts.adminmaster')
		...
		@section('styles')
		@if(auth()->user()->auto_refresh != "Null")
		<meta http-equiv="refresh" content="{{auth()->user()->auto_refresh}}">
		@endif
		@endsection
								...
								<div class="card ">
									<div class="card-header border-0 d-sm-max-flex ">
										...
										<div class="card-options mt-sm-max-2">
											...
											<a href="javascript:void(0)" class="btn btn-secondary me-3"  id="create-new-testimonial">Create Category</a>
			...
			(function($)  {
				...
				$('body').on('click', '.edit-testimonial', function () {
					...
					$.get('categories/' + testimonial_id  + '/edit', function (data) {
						...
						{
							$('#myonoffswitch188').prop('checked', true);
						}
						$('.categorysub').select2({
							dropdownParent: ".sprukosubcat",
							minimumResultsForSearch: '',
				...
				$('body').on('click', '#assigneds', function () {
					...
					$.get('groupassigned/' + assigned_group , function (data) {
						...
						$(".modal-title").text('Assign To Groups');
						$('#groupname').html('');
