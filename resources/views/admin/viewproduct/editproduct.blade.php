								...
								<div class="card-body">
									<div class="form-group ">
										<div class="row">
											...
											<div class="col-md-9">
												<input type="text" id="title" class="form-control @error('title') is-invalid @enderror" placeholder="Title" name="title" value="{{ $product->title }}">
									...
									<div class="form-group ticket-summernote ">
										<div class="row">
											...
											<div class="col-md-9">
												<textarea class=" form-control @error('sort_description') is-invalid @enderror" rows="7" name="sort_description" >{{$product->sort_description}}</textarea>
									...
									<div class="form-group ticket-summernote ">
										<div class="row">
											...
											<div class="col-md-9">
												<textarea class="summernote form-control @error('description') is-invalid @enderror" rows="7" name="description" id="me">{{$product->description}}</textarea>
