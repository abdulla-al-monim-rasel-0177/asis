...
@endsection
					...
					<div class="page-header d-xl-flex d-block">
						<div class="page-leftheader">
							<h4 class="page-title"><span class="font-weight-normal text-muted ms-2">Create Solution</span></h4>
						</div>
					</div>
					<!--End Page header-->
								...
								<div class="card-body">
									...
									<div class="form-group ticket-summernote ">
										<div class="row">
											...
											<div class="col-md-9">
												<textarea class=" form-control" rows="7" name="technical_training" >{{old('technical_training')}}</textarea>
									...
									<div class="form-group ticket-summernote ">
										<div class="row">
											...
											<div class="col-md-9">
												<textarea class=" form-control" rows="7" name="repair_warranty_center" >{{old('repair_warranty_center')}}</textarea>
									...
									<div class="form-group ticket-summernote ">
										<div class="row">
											...
											<div class="col-md-9">
												<textarea class=" form-control" rows="7" name="logistics_warehouse" >{{old('logistics_warehouse')}}</textarea>
									...
									<div class="form-group ticket-summernote ">
										<div class="row">
											...
											<div class="col-md-9">
												<textarea class=" form-control" rows="7" name="product_approvals" >{{old('product_approvals')}}</textarea>
									...
									<div class="form-group ticket-summernote ">
										<div class="row">
											...
											<div class="col-md-9">
												<textarea class=" form-control" rows="7" name="lmport_clearance" >{{old('	lmport_clearance')}}</textarea>
									...
									<div class="form-group ticket-summernote ">
										<div class="row">
											...
											<div class="col-md-9">
												<textarea class=" form-control" rows="7" name="marketing_sales" >{{old('	marketing_sales')}}</textarea>
