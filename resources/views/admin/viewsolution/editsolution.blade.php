...
@endsection
					...
					<div class="page-header d-xl-flex d-block">
						<div class="page-leftheader">
							<h4 class="page-title"><span class="font-weight-normal text-muted ms-2">Edit Solution</span></h4>
						</div>
					</div>
					<!--End Page header-->
							...
							<form method="post" id="admin_form"  enctype="multipart/form-data" >
								...
								<div class="card-body">
									<div class="form-group ">
										<div class="row">
											<div class="col-md-3">
												<label class="form-label mb-0 mt-2">Solution Title  <span class="text-red">*</span></label>
											</div>
											<div class="col-md-9">
												<input type="text" id="title" class="form-control @error('title') is-invalid @enderror" placeholder="Title" name="title" value="{{ $solution->title }}">
									...
									<div class="form-group ticket-summernote ">
										<div class="row">
											<div class="col-md-3">
												<label class="form-label mb-0 mt-2">Solution Sort Description<span class="text-red">*</span></label>
											</div>
											<div class="col-md-9">
												<textarea class=" form-control @error('sort_description') is-invalid @enderror" rows="7" name="sort_description" >{{$solution->sort_description}}</textarea>
									...
									<div class="form-group ticket-summernote ">
										<div class="row">
											<div class="col-md-3">
												<label class="form-label mb-0 mt-2">Technical Training<span class="text-red">*</span></label>
											</div>
											<div class="col-md-9">
												<textarea class=" form-control" rows="7" name="technical_training" >{{$solution->technical_training}}</textarea>
									...
									<div class="form-group ticket-summernote ">
										<div class="row">
											<div class="col-md-3">
												<label class="form-label mb-0 mt-2"> Repair & warranty center<span class="text-red">*</span></label>
											</div>
											<div class="col-md-9">
												<textarea class=" form-control" rows="7" name="repair_warranty_center" >{{$solution->repair_warranty_center}}</textarea>
									...
									<div class="form-group ticket-summernote ">
										<div class="row">
											<div class="col-md-3">
												<label class="form-label mb-0 mt-2"> Logistics  & Warehouse <span class="text-red">*</span></label>
											</div>
											<div class="col-md-9">
												<textarea class=" form-control" rows="7" name="logistics_warehouse" >{{$solution->logistics_warehouse}}</textarea>
									...
									<div class="form-group ticket-summernote ">
										<div class="row">
											<div class="col-md-3">
												<label class="form-label mb-0 mt-2"> Product Approvals <span class="text-red">*</span></label>
											</div>
											<div class="col-md-9">
												<textarea class=" form-control" rows="7" name="product_approvals" >{{$solution->product_approvals}}</textarea>
									...
									<div class="form-group ticket-summernote ">
										<div class="row">
											<div class="col-md-3">
												<label class="form-label mb-0 mt-2"> Import & Clearance <span class="text-red">*</span></label>
											</div>
											<div class="col-md-9">
												<textarea class=" form-control" rows="7" name="lmport_clearance" >{{$solution->lmport_clearance}}</textarea>
									...
									<div class="form-group ticket-summernote ">
										<div class="row">
											<div class="col-md-3">
												<label class="form-label mb-0 mt-2"> Marketing & Sales <span class="text-red">*</span></label>
											</div>
											<div class="col-md-9">
												<textarea class=" form-control" rows="7" name="marketing_sales" >{{$solution->marketing_sales}}</textarea>
									...
									<div class="form-group ticket-summernote ">
										<div class="row">
											<div class="col-md-3">
												<label class="form-label mb-0 mt-2">Solution Description<span class="text-red">*</span></label>
											</div>
											<div class="col-md-9">
												<textarea class="summernote form-control @error('description') is-invalid @enderror" rows="7" name="description" id="me">{{$solution->description}}</textarea>
			...
			$('body').on('submit', '#admin_form', function (e) {
				...
				$.ajax({
					...
					success: (data) => {
						...
						window.location.replace('{{url('admin/allsolutions')}}');
